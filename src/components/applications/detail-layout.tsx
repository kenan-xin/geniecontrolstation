...
import { ApplicationWorkflowStepper } from './workflow-stepper';
import { SectionNav, type SectionItem } from '@/components/news-verification/section-nav';
    ...
    <div className={cn('min-h-screen bg-background', className)}>
      ...
      <header className="sticky top-0 z-30 bg-background border-b">
        <div className="flex items-center justify-between gap-4 px-4 sm:px-6 py-3">
          <div className="flex items-center gap-3 min-w-0">
            ...
            >
              ...
              <span className="hidden sm:inline text-sm font-medium">Back to Applications</span>
        ...
        <div className="px-4 sm:px-6 py-4 border-t bg-muted/20">
          <ApplicationWorkflowStepper activeStep={activeStep} />
        </div>
      </header>
