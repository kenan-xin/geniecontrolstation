...
interface DocumentAssessmentViewProps {
  application: Application;
}

export function DocumentAssessmentView({ application }: DocumentAssessmentViewProps) {
  ...
  const handleAdvance = () => {
    const nextStatus = "Candidate Screening";
    ...
    updateMutation.mutate(
      ...
      {
        onSuccess: () => {
          toast.success("Application advanced to Candidate Screening");
          setAdvanceDialogOpen(false);
          router.push(`/applications/candidate-screening/${application.id}`);
        },
        onError: () => {
    ...
    <>
      ...
      <Dialog open={advanceDialogOpen} onOpenChange={setAdvanceDialogOpen}>
        <DialogContent className="sm:max-w-lg">
          <DialogHeader>
            <DialogTitle>Advance to Candidate Screening</DialogTitle>
            <DialogDescription>
